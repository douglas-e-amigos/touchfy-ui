...
### User Story US06 - Reprodução de playlist e controle de reprodução

| 📌 User Story - US06 | Reprodução de playlist |
|---------------------|--|
| *Título* | Reproduzir playlists e controlar reprodução |
| *Identificação* | US06 - Reprodução de playlist |
