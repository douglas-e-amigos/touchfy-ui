...
| 07/04/2026 | 0.0.4   | Altera númeração para seguir em ordem crescente desde o arquivo de usuarios | Diana |

### Tabelas de Users Stories
| Nome | Título |
|------|-----------|
| US05 | Reproduzir música e visualizar informações básicas      |
| US06 | Controlar reprodução da música      |
| US07 | Curtir música e acessar músicas curtidas      |
| US08 | Acessar músicas curtidas      |
| US09 | Visualizar créditos da música      |
| US10 | Ocultar música das recomendações e reproduções automáticas      |
| US11 | Compartilhar música      |
| US12 | Adicionar música à playlist e à fila de reprodução      |
| US13 | Reproduzir músicas em ordem aleatória      |
| US14 | Receber recomendações de músicas      |
| US15 | Visualizar letra da música      |

---

### User Story US05 - Visualizar informações básicas
...
### User Story US06 - Controlar reprodução da música
...
---
### User Story US08 - Acessar músicas curtidas
...
### User Story US09 - Visualizar créditos da música
...
### User Story US010 - Ocultar música das recomendações e reproduções automáticas 
...
### User Story US11 - Compartilhar música
...
### User Story US12 - Adicionar música à playlist e à fila de reprodução
...
### User Story US13 - Reproduzir músicas em ordem aleatória
...
### User Story US14 - Receber recomendações de músicas
...
### User Story US15 - Visualizar letra da música
